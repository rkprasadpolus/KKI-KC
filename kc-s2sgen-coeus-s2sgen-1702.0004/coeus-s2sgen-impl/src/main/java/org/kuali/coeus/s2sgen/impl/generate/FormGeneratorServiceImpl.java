...
public class FormGeneratorServiceImpl implements FormGeneratorService {
	 ...
	 */
	protected FormGenerationResult generateAndValidateForms(Forms forms, List<AttachmentData> attList, ProposalDevelopmentDocumentContract pdDoc) throws S2SException {
    ...
    protected String getGrantApplicationDocument(
        ...
        if(pdDoc.getDevelopmentProposal().getCfdaNumber()!=null){
            ...
            final String activityTitle = pdDoc.getDevelopmentProposal().getS2sOpportunity().getCfdaDescription();
    ...
    public FormGenerationResult validateUserAttachedFormFile(S2sUserAttachedFormFileContract s2sUserAttachedFormFile,String formName) throws S2SException {
        ...
        FormGenerationResult result = new FormGenerationResult();
        result.setValid(validationSucceeded);
        result.setApplicationXml(s2sUserAttachedFormFile.getXmlFile());
        result.setErrors(auditErrors);
        return result;
    }
