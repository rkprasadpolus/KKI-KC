...
xmlns:NSF_CoverPage_1_7="http://apply.grants.gov/forms/NSF_CoverPage_1_7-V1.7"
...
xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xsl:template match="NSF_CoverPage_1_7:NSF_CoverPage_1_7">
		<fo:root>
													...
													<fo:table-row>
														...
														<fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" hyphenate="true" language="en">
															<fo:block font-size="8pt">
																<xsl:value-of select="NSF_CoverPage_1_7:FundingOpportunityNumber"/>
															</fo:block>
														</fo:table-cell>
														<fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" number-columns-spanned="3">
															<fo:block font-size="8pt">Opportunity closing date:
																...
																<xsl:for-each select="NSF_CoverPage_1_7:DueDate">
													...
													<fo:table-row>
														...
														<fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="1pt">
															<fo:block font-size="8pt" hyphenate="true" language="en">
																<xsl:value-of select="NSF_CoverPage_1_7:NSFUnitConsideration/NSF_CoverPage_1_7:DivisionCode"/>
															</fo:block>
														</fo:table-cell>
														<fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="1pt">
														...
														<fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="1pt">
															<fo:block font-size="8pt" hyphenate="true" language="en">
																<xsl:value-of select="NSF_CoverPage_1_7:NSFUnitConsideration/NSF_CoverPage_1_7:DivisionName"/>
															</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														...
														<fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="1pt">
															<fo:block font-size="8pt" hyphenate="true" language="en">
																<xsl:value-of select="NSF_CoverPage_1_7:NSFUnitConsideration/NSF_CoverPage_1_7:ProgramCode"/>
															</fo:block>
														</fo:table-cell>
														<fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="1pt">
														...
														<fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="1pt">
															<fo:block font-size="8pt" hyphenate="true" language="en">
																<xsl:value-of select="NSF_CoverPage_1_7:NSFUnitConsideration/NSF_CoverPage_1_7:ProgramName"/>
															</fo:block>
														</fo:table-cell>
													</fo:table-row>
												</fo:table-body>
												...
												<fo:table-body>
													...
													<fo:table-row>
														<fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="15pt" number-columns-spanned="4">
															<fo:block font-size="8pt">
																<xsl:choose>
																	<xsl:when test="NSF_CoverPage_1_7:PIInfo/NSF_CoverPage_1_7:isCurrentPI !='N: No'">
												...
												<fo:table-body>
													...
													<fo:table-row>
														<fo:table-cell padding-before="1pt" padding-after="1pt" padding-end="1pt" padding-start="15pt">
															<fo:block font-size="8pt">
																<xsl:choose>
																	<xsl:when test="NSF_CoverPage_1_7:OtherInfo/NSF_CoverPage_1_7:isBeginInvestigator !='N: No'">
																		<fo:inline text-decoration="underline" font-family="ZapfDingbats" font-size="8pt" padding-start="1.5pt" padding-end="1.5pt">&#x2714;</fo:inline>
																	</xsl:when>
																	<xsl:otherwise>
																		<fo:inline text-decoration="underline" color="black">
														...
														<fo:table-cell padding-before="1pt" padding-after="1pt" padding-end="1pt" padding-start="1pt">
															<fo:block font-size="8pt">Beginning Investigator (Proposal &amp; Award Policies &amp; Procedures
                                                                Guide (PAPPG) Chapter II.D.2))</fo:block>
														</fo:table-cell>
														<fo:table-cell padding-before="1pt" padding-after="1pt" padding-end="1pt" padding-start="1pt">
															<fo:block font-size="8pt">
																<xsl:choose>
																	<xsl:when test="NSF_CoverPage_1_7:OtherInfo/NSF_CoverPage_1_7:isDisclosureLobbyingActivities !='N: No'">
																		<fo:inline text-decoration="underline" font-family="ZapfDingbats" font-size="8pt" padding-start="1.5pt" padding-end="1.5pt">&#x2714;</fo:inline>
																	</xsl:when>
																	<xsl:otherwise>
																		<fo:inline text-decoration="underline" color="black">
														...
														<fo:table-cell padding-before="1pt" padding-after="1pt" padding-end="1pt" padding-start="1pt">
															<fo:block font-size="8pt">Disclosure of Lobbying Activities (PAPPG Chapter II.C.1.d and Exhibit II-5)</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell padding-before="1pt" padding-after="1pt" padding-end="1pt" padding-start="15pt">
															<fo:block font-size="8pt">
																<xsl:choose>
																	<xsl:when test="NSF_CoverPage_1_7:OtherInfo/NSF_CoverPage_1_7:isAccomplishmentRenewal !='N: No'">
																		<fo:inline text-decoration="underline" font-family="ZapfDingbats" font-size="8pt" padding-start="1.5pt" padding-end="1.5pt">&#x2714;</fo:inline>
																	</xsl:when>
																	<xsl:otherwise>
																		<fo:inline text-decoration="underline" color="black">
														...
														<fo:table-cell padding-before="1pt" padding-after="1pt" padding-end="1pt" padding-start="1pt">
															<fo:block font-size="8pt">Accomplishment-Based Renewal  (PAPPG Chapter V.B)																		</fo:block>
										...
										<fo:block>
											<fo:table space-before.optimum="1pt" space-after.optimum="2pt" width="100%" table-layout="fixed">
												...
												<fo:table-body>
													...
													<xsl:for-each select="NSF_CoverPage_1_7:Single-CopyDocuments/att:AttachedFile">
														<fo:table-row>
															<fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="15pt">
																<fo:block font-size="8pt" hyphenate="true" language="en">
                                                    ...
                                                    <fo:table-row>
                                                        <fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="15pt">
                                                            <fo:block font-size="8pt" hyphenate="true" language="en">
                                                                <xsl:value-of select="NSF_CoverPage_1_7:Data-Management-Plan/att:FileName"/>
                                                            </fo:block>
                                                        </fo:table-cell>
                                                        <fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="1pt">
                                                            <fo:block font-size="8pt" hyphenate="true" language="en">
                                                                <xsl:value-of select="NSF_CoverPage_1_7:Data-Management-Plan/att:MimeType"/>
                                                            </fo:block>
                                                        </fo:table-cell>
                                                        </fo:table-row>
                                                    <fo:table-row>
                                                        ...
                                                        <fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="15pt">
                                                            <fo:block font-size="8pt">Postdoctoral Researcher Mentoring Plan, required for proposals that request funding to support postdoctoral researchers (PAPPG Chapter II.C.2.j)
                                                        </fo:block>
                                                        </fo:table-cell>
                                                    </fo:table-row>
                                                    <fo:table-row>
                                                    ...
                                                    <fo:table-row>
                                                        <fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="15pt">
                                                            <fo:block font-size="8pt" hyphenate="true" language="en">
                                                                <xsl:value-of select="NSF_CoverPage_1_7:Mentoring-Plan/att:FileName"/>
                                                                </fo:block>
                                                        </fo:table-cell>
                                                        <fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="1pt">
                                                            <fo:block font-size="8pt" hyphenate="true" language="en">
                                                                <xsl:value-of select="NSF_CoverPage_1_7:Mentoring-Plan/att:MimeType"/>
                                                            </fo:block>
                                                        </fo:table-cell>
                                                    </fo:table-row>
                                                    <fo:table-row>
                                                        <fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="15pt">
                                                            <fo:block font-size="8pt">
                                                                <fo:inline font-weight="bold">8. GOALI - Industrial PI Confirmation Letter</fo:inline>
                                                            </fo:block>
                                                        </fo:table-cell>
                                                    </fo:table-row>
                                                    <fo:table-row>
                                                    ...
                                                    <fo:table-row>
                                                        <fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="15pt">
                                                            <fo:block font-size="8pt" hyphenate="true" language="en">
                                                                <xsl:value-of select="NSF_CoverPage_1_7:GOALILetter/att:FileName"/>
                                                            </fo:block>
                                                        </fo:table-cell>
                                                        <fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="1pt">
                                                            <fo:block font-size="8pt" hyphenate="true" language="en">
                                                                <xsl:value-of select="NSF_CoverPage_1_7:GOALILetter/att:MimeType"/>
                                                            </fo:block>
                                                        </fo:table-cell>
                                                    </fo:table-row>
                                                    <fo:table-row>
                                                        <fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="15pt">
                                                            <fo:block font-size="8pt">
                                                                <fo:inline font-weight="bold">9. RAISE - Program Officer Concurrence Emails</fo:inline>
                                                            </fo:block>
                                                        </fo:table-cell>
                                                    </fo:table-row>
                                                    <fo:table-row>
                                                    ...
                                                    <fo:table-row>
                                                        <fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="15pt">
                                                            <fo:block font-size="8pt" hyphenate="true" language="en">
                                                                <xsl:value-of select="NSF_CoverPage_1_7:RAISEEmails/att:FileName"/>
                                                            </fo:block>
                                                        </fo:table-cell>
                                                        <fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="1pt">
                                                            <fo:block font-size="8pt" hyphenate="true" language="en">
                                                                <xsl:value-of select="NSF_CoverPage_1_7:RAISEEmails/att:MimeType"/>
                                                            </fo:block>
                                                        </fo:table-cell>
                                                    </fo:table-row>
												</fo:table-body>
                                        ...
                                        <fo:block>
                                            <fo:table space-before.optimum="1pt" space-after.optimum="2pt" width="100%" table-layout="fixed">
                                                ...
                                                <fo:table-body>
                                                    <fo:table-row>
                                                        <fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="15pt" number-columns-spanned="2">
                                                            <fo:block font-size="8pt" font-weight="bold">10. Funding Mechanism</fo:block>
                                                        </fo:table-cell>
                                                        <fo:table-cell padding-before="2pt" padding-after="2pt" padding-end="1pt" padding-start="15pt" number-columns-spanned="2">
                                                            <fo:block font-size="8pt">
                                                                <xsl:value-of select="NSF_CoverPage_1_7:FundingMechanism"/>
                                                            </fo:block>
                                                        </fo:table-cell>
                                                    </fo:table-row>
                                                </fo:table-body>
