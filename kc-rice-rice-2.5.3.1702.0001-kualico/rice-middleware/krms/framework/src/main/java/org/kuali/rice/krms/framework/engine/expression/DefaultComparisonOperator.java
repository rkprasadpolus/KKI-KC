                ...
                if (result instanceof String) { // was coercion successful?
                    if (objectArg instanceof BigDecimal) {
                        try {
                            ...
                            throw new IncompatibleTypeException(e, "Could not coerce String to BigDecimal" + this, stringArg, objectArg.getClass());
                        }
                    } else if (objectArg instanceof BigInteger) {
                        try {
                            result = BigInteger.valueOf(Long.valueOf(stringArg.toString()));
                        } catch (NumberFormatException e) {
                            throw new IncompatibleTypeException(e, "Could not coerce String to BigInteger" + this, stringArg, objectArg.getClass());
                        }
                    } else {
        ...
        for (Class clazz : clazzes) {
            if (clazz.isInstance(objectArg)) {
                try {
                    ...
                    throw new IncompatibleTypeException(e, "Could not coerce String to " +
