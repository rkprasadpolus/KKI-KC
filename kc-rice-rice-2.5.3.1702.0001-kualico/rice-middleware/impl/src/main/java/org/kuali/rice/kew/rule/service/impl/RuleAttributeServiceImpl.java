...
public class RuleAttributeServiceImpl implements RuleAttributeService {
    ...
    public void loadXml(InputStream inputStream, String principalId) {
        ...
        try {
            ...
            throw new WorkflowServiceErrorException("XML file not found", e, new WorkflowServiceErrorImpl("Rule Attribute XML file not found", XML_FILE_NOT_FOUND) );
    	} catch (Exception e) { //any other exception
            LOG.error("Error loading xml file", e);
            throw new WorkflowServiceErrorException("Error loading xml file", e, new WorkflowServiceErrorImpl("Error loading xml file", XML_PARSE_ERROR));
        }
    }
