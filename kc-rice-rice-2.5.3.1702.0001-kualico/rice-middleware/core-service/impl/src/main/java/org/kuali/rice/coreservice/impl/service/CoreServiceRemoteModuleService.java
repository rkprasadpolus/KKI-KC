...
public class CoreServiceRemoteModuleService extends RemoteModuleServiceBase {
    ...
    private boolean fieldMatches(Object ebo, Map.Entry<String,Object> fieldValue) {
        try {
            ...
            LOG.warn("querying " + ebo.getClass().getName() + " for an inaccessible field called '" + fieldValue.getKey() + "'", e );
        } catch (InvocationTargetException e) {
            LOG.warn("exception querying " + ebo.getClass().getName() + " for a field called '" + fieldValue.getKey() + "'", e );
        } catch (NoSuchMethodException e) {
            LOG.warn("querying " + ebo.getClass().getName() + " for an invalid field called '" + fieldValue.getKey() + "'", e );
        }
        return false;
    }
