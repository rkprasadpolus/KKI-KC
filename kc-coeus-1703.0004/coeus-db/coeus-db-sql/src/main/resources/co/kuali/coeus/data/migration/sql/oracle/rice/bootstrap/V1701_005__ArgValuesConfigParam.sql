...
VALUES ('KC-GEN','All','ARG_VALUE_VALUES_FINDER_ARG_CONFIG',sys_guid(),1,'CONFG','',
				'Configures a specific argumentName to determine whether to the display description, value or both.
