...
COST_SHARE_TYPE_CODE DECIMAL(3) NOT NULL,
SOURCE_ACCOUNT_CODE DECIMAL(12,0) NOT NULL,
...
CREATE TABLE SEQ_VAL_SRC_ACNTS_COST_ID
(
	id bigint(19) not null auto_increment, primary key (id)
) ENGINE MyISAM;

ALTER TABLE SEQ_VAL_SRC_ACNTS_COST_ID auto_increment = 1;
